...
import { postComment,postAnswer, deleteQuestion, voteQuestion } from '../../actions/question'
...
const QuestionsDetails = () => {
    ...
    const url = 'https://stack-rishabh.netlify.app'
    ...
    const handlePostCom = (e, commentLength) =>{
        e.preventDefault()
        if(User === null){
            alert('Login or Signup to comment a question or answer')
            Navigate('/Auth')
        }else{
            if(Comment === ''){
